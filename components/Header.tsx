    ...
    <header className="w-full bg-terminal-300 border-b border-cyber-700 sticky top-0 z-50 relative">
      <div className="container mx-auto px-4 py-3 relative">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <a href="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity min-w-0 shrink-0">
            <svg
            ...
            <span className="hidden sm:inline text-sm font-mono font-bold text-cyber-500 tracking-wide">
              [safespace@krinc]$
            </span>
            <span className="inline sm:hidden text-sm font-mono font-bold text-cyber-500 tracking-wide">
              [ss]$
            </span>
          </a>
